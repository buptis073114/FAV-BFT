...
RUN apt-get update && apt-get -y install bison flex libgmp-dev libmpc-dev build-essential gcc g++

RUN wget https://crypto.stanford.edu/pbc/files/pbc-0.5.14.tar.gz --no-check-certificate
